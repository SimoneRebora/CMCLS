...
# Who wrote the ANONYMOUS text? To answer the question...
# upload the "ANONYMOUS.txt" file to the "corpus" folder and repeat the analyses

# ...to upload the file
# you can use the "Upload" function in the "files" panel

# ...to move the file to the "corpus" folder
# select it in the "files" panel
# and click on "More -> Copy to"

# After having run the analyses...
# export one of the visualizations ("Plots -> Export -> Save as image")
# or use the file generated by the third analysis
# download it to your computer (select the file and "More -> Export")
# and save it to the Moodle, Hands-on 3
